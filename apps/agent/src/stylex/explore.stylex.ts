...
export const exploreStyles = stylex.create({
  ...
  pendingGlobeSphere: {
    fill: "color-mix(in srgb, #8fa77b 10%, #e3e4de)",
    stroke: "color-mix(in srgb, #637d84 68%, transparent)",
    strokeDasharray: "8 7",
    strokeWidth: 2,
  },
  pendingGlobeLine: {
    fill: "none",
    stroke: "color-mix(in srgb, #637d84 24%, transparent)",
    strokeWidth: 1,
  },
  pendingCanvasStatus: {
    alignItems: "center",
    backdropFilter: "blur(12px)",
    backgroundColor: "color-mix(in srgb, #e3e4de 80%, transparent)",
    borderColor: "color-mix(in srgb, #637d84 28%, transparent)",
    borderStyle: "solid",
    borderWidth: 1,
    display: "flex",
    flexDirection: "column",
