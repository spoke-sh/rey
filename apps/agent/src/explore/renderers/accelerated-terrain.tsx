...
export interface AcceleratedTerrainReport {
  ...
  landscape_relief_border_digest_mismatches: number;
  ...
  landscape_source_contribution_id: string;
  landscape_conflict_id: string;
  ...
  landscape_companion_attribution_id: string;
...
export const REFERENCE_TERRAIN_REPORT: AcceleratedTerrainReport = Object.freeze(
  {
    ...
    landscape_source_contribution_id: "unbound",
    landscape_conflict_id: "unbound",
    ...
    landscape_companion_attribution_id: "unbound",
...
export function AcceleratedTerrainSurface({
  ...
  const completeReport = (
    ...
    onReport({
      ...
      landscape_relief_hierarchy_levels:
      ...
      landscape_relief_border_digest_mismatches:
        activeTerrain?.result.metrics.relief_border_digest_mismatches ?? 0,
      ...
      landscape_source_contribution_id:
        snapshot.scene.terrain_fields.find((field) => field.landscape_mosaic)
          ?.landscape_mosaic?.source_contribution_id ?? "unbound",
      landscape_conflict_id:
        snapshot.scene.terrain_fields.find((field) => field.landscape_mosaic)
          ?.landscape_mosaic?.conflict_id ?? "unbound",
      landscape_conflict_vertices:
        snapshot.scene.terrain_fields.find((field) => field.landscape_mosaic)
          ?.landscape_mosaic?.conflict_vertices ?? 0,
      landscape_feather_id:
        snapshot.scene.terrain_fields.find((field) => field.landscape_mosaic)
          ?.landscape_mosaic?.feather_id ?? "unbound",
      ...
      landscape_companion_attribution_id:
        snapshot.scene.terrain_fields.find((field) => field.landscape_mosaic)
          ?.landscape_mosaic?.companion_attribution_id ?? "unbound",
