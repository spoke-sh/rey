  ...
  it("fades the Atlas sector out through the Atlas-to-Landscape band instead of hard-cutting it at the regime boundary", () => {
    const landscapeScene: TopologyScene = {
      ...
      atlas_landscape_transition: {
        ...
        terrain_field_ids: ["dataset:focused"],
        mosaic_id: "mosaic:focused",
        composition_revision: "composition:focused",
        primary_patch_id: "dataset:focused",
        patch_set_id: "rey.landscape-patch-set@1:dataset:focused",
    ...
    const acceleratedAtlasMarkup = renderToStaticMarkup(
      <ReferenceRenderer
        atlasLandscapeMorphProgress={presentation.progress}
        atlasLandscapePresentation={presentation}
    ...
    expect(acceleratedAtlasMarkup).not.toContain(
