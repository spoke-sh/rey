...
- [x] Establish Feed and Agents readiness from their native projections,
      attach portfolio-derived sections progressively, coalesce concurrent server
      projections, and keep packed terrain transport proportional to retained
      value columns rather than derived per-cell identity repetition.
