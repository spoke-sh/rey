...
| --- | --- | --- | --- |
| [0001 — Close the runtime loop](0001-runtime-loop.md) | Active | Extend activation evidence beyond HEAD/index, then close retry, cancellation, and partial-failure recurrence bounds. | Implemented ownership/invalidation edge proofs, attention/frontier and harness handoffs, bounded Git cadence, exact activation admission/execution, compatible result reuse, and selected-versus-full recomputation proof. |
