...
| --- | --- | --- | --- |
| [0003 — Admit scenes and complete Explorer](0003-scene-to-explorer.md) | Active | Deep-link each selected County object to its exact evidence envelope. | Implemented editor-to-admission-to-Explorer voyage, projection packets, retained survey/regional atlas history with exact scene back-references, stable occupied sectors, typed deltas, reversible Mercator geometry, immutable/continuous World/Atlas transition, bounded wrapping/inverse picking/recentering, focus-preserving deterministic label layout, explicit regional selection, a verified reversible envelope-centered County frame, exact admitted footprint fabric/validity, and independent admitted native layer kinds. |
