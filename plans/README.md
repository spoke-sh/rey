...
| --- | --- | --- | --- |
| [0003 — Admit scenes and complete Explorer](0003-scene-to-explorer.md) | Active | Record the atlas revision back onto an accepted scene without creating a circular identity, then add stable sector identity without conflating sectors and native County footprints. | Implemented editor-to-admission-to-Explorer voyage, projection packets, retained survey/regional atlas history and typed deltas, and renderer boundary. |
