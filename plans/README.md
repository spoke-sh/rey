...
| [0005 — Deliver geographic Landscape terrain](0005-landscape-terrain.md) | Active | Complete the haloed height/relief hierarchy over the shared mosaic, retain border digests, and cut camera LOD, residency, and prewarm reuse over its exact levels before composing MDOW/SVF relief. | Implemented exact grid admission, independent byte reinspection, content-identified validity, renderer-neutral fields, conservative tiles, complete-field relief before tile cropping, whole-field/partition equivalence diagnostics, cancellable worker evaluation, bounded residency, a 3D camera, stable focus-selectable terrain-component identities shared by CLI and browser, a connected shared-frame regional mosaic, deterministic evidence-aware overlap resolution, mutually valid feathering, separately admitted overview gap coverage, independent companion attribution, a conservative height-hierarchy prototype, reversible multi-patch Atlas-to-Landscape projection, executable geographic passes, reference/GPU parity, instrumentation, the explicit-hole fixture, and a production first-principles Rey County terrain dataset.                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
editor candidate → scene admission → retained atlas delta
                 ...
                 → admitted terrain grid → tiled Landscape fidelity
```
