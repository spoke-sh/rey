...
| [0005 — Deliver geographic Landscape terrain](0005-landscape-terrain.md) | Active | Select one connected terrain-qualified regional set, compile it through the seam-safe mosaic contract, and expose exact composition and omission lineage.          | Implemented exact grid admission, independent byte reinspection, content-identified validity, renderer-neutral fields, conservative tiles, complete-field relief before tile cropping, whole-field/partition equivalence diagnostics, cancellable worker evaluation, bounded residency, a 3D camera, reversible multi-patch Atlas-to-Landscape projection, executable geographic passes, reference/GPU parity, instrumentation, the explicit-hole fixture, a production first-principles Rey County terrain dataset, and an enabling aligned-mosaic contract that is not yet selected by `/explore`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
