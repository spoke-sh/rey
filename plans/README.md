...
| [0005 — Deliver geographic Landscape terrain](0005-landscape-terrain.md) | Active | Expose the exact selected mosaic and fallback omissions through the CLI, then admit deterministic overlap/overview policy without expanding validity.              | Implemented exact grid admission, independent byte reinspection, content-identified validity, renderer-neutral fields, conservative tiles, complete-field relief before tile cropping, whole-field/partition equivalence diagnostics, cancellable worker evaluation, bounded residency, a 3D camera, a connected conflict-free shared-frame regional mosaic, reversible multi-patch Atlas-to-Landscape projection, executable geographic passes, reference/GPU parity, instrumentation, the explicit-hole fixture, and a production first-principles Rey County terrain dataset.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
