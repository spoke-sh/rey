...
| [0005 — Deliver geographic Landscape terrain](0005-landscape-terrain.md) | Active | Add bounded terrain tiles, worker evaluation, validity-safe borders, deterministic residency, and named CPU/GPU budgets over the admitted regional grid.           | Implemented exact rectilinear grid admission from frozen native GeoJSON, independent byte reinspection, content-identified row-major cells, explicit valid/no-data support, CLI disclosure, renderer-neutral regional fields, shared validity-safe reference/GPU triangulation, immutable dataset/compiler lineage, and Rust/Vitest coverage.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
