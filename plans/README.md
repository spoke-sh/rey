...
| [0005 — Deliver geographic Landscape terrain](0005-landscape-terrain.md) | Active | Compile relief before render-tile cropping and prove whole-field/partitioned equivalence, explicit validity, lineage, and budgets through the CLI.                 | Implemented exact grid admission, independent byte reinspection, content-identified validity, renderer-neutral fields, conservative tiles, cancellable worker evaluation, bounded residency, a 3D camera, reversible multi-patch Atlas-to-Landscape projection, executable geographic passes, reference/GPU parity, instrumentation, the explicit-hole fixture, a production first-principles Rey County terrain dataset, and enabling relief/patch-set prototypes that do not yet form a shared-datum seam-safe mosaic.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
