...
| [0005 — Deliver geographic Landscape terrain](0005-landscape-terrain.md) | Active | Retain the complete named fidelity/backend/viewport matrix and repeat the full journey through direct browser transport on one exact machine.                      | Implemented exact grid admission, independent byte reinspection, content-identified validity, renderer-neutral fields, conservative tiles, cancellable worker evaluation, bounded residency, a 3D camera, reversible Atlas-to-Landscape projection, executable geographic passes, reference/GPU parity, instrumentation, the explicit-hole fixture, and a production first-principles Rey County terrain dataset.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
