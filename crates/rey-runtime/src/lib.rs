...
pub use workload::{
    ...
    WorkloadDefinitionParts, WorkloadError, WorkloadGitDependency, WorkloadGitDependencyKind,
    WorkloadLimits, WorkloadOwnedSurface, WorkloadPort, WorkloadRunResult, WorkloadTestResult,
    WorkloadValue, built_in_operation_contract, built_in_workload, built_in_workloads,
    execute_workload, execute_workload_with_source, execute_workload_with_topography, run_workload,
    run_workload_with_source, run_workload_with_topography, test_workload,
