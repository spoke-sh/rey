...
- terrain meshes, validity holes, CPU/upload parity, byte accounting, camera
  projection, TSL material creation, and GPU budget; and
- globe and terrain structure through the React Three test renderer.
...
| Render passes        | Materialize the application graph as explicit R3F components with authority and availability retained.                           |
