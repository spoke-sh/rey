...
| [0019](0019-git-shaped-environment-history.md) | Accepted | Hard-cut `env` CLI, verified local environment commits, status, and patch-bearing linear history |
...
| [0027](0027-environment-operator-delta.md) | Accepted; application presentation superseded by 0031 | Shared CLI/UI environment delta, bounded value capture, env-shaped variable diff, and found/not-found application evidence |
